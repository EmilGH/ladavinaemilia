    ...
    <main id="main">
      <section class="hero" id="top">
        ...
        <div class="hero-copy">
          ...
          <div class="hero-actions"><a class="button button-primary" href="/who-i-am.php">Meet Emilia</a><a class="text-link" href="#survey">Are you worthy of her time? <span aria-hidden="true">↗</span></a></div>
        </div>
        <figure class="hero-portrait portrait public-portrait hero-logo">
          ...
          <img src="invoice-logo-under-2mb.png" alt="Illustrated La Davina Emilia logo with an open book and celestial headpiece">
        </figure>
      ...
      <section class="about section" id="emilia">
        ...
        <div class="about-grid">
          <figure class="about-image personal-photo">
            <?php if ($photoAccess): ?>
              <img src="image.php?id=about&amp;collection=home" alt="La Davina Emilia by the water">
            <?php else: ?>
              <a class="private-photo-gate" href="gate.php?collection=home&amp;return=<?= rawurlencode($_SERVER['REQUEST_URI']) ?>"><span aria-hidden="true">✦</span><strong>Portrait in her element</strong><small>Enter Emilia’s word to look closer</small></a>
            <?php endif; ?>
          </figure>
      ...
      <section class="journal section" id="journal">
        <div class="journal-heading"><div class="section-label"><span>03</span> Emilia’s journal</div><h2>Vespers from the places where she <em>comes alive.</em></h2><p>A Goddess keeps records. These are mine: trips, treasures, and thoughts too good to waste on a caption.</p></div>
        <div class="journal-grid">
          <a class="journal-item" href="/journal.php"><span>Now reading</span><strong>Notes From The Road</strong><i>Open the journal <span aria-hidden="true">↗</span></i></a>
          <a class="journal-item" href="/art.php"><span>Private collection</span><strong>The Art of Being Unforgettable</strong><i>Read the lessons <span aria-hidden="true">↗</span></i></a>
      ...
      <section class="album section" id="album">
        ...
        <div class="album-grid">
          <figure class="album-photo album-tall personal-photo">
            <?php if ($photoAccess): ?><img src="image.php?id=travel&amp;collection=home" alt="La Davina Emilia in the city at dusk"><?php else: ?><a class="private-photo-gate" href="gate.php?collection=home&amp;return=<?= rawurlencode($_SERVER['REQUEST_URI']) ?>"><span aria-hidden="true">✦</span><strong>Travel portrait</strong><small>Enter Emilia’s word to look closer</small></a><?php endif; ?>
            <figcaption>Somewhere worth arriving for.</figcaption>
          </figure>
          <figure class="album-photo personal-photo">
            <?php if ($photoAccess): ?><img src="image.php?id=white-linen&amp;collection=home" alt="La Davina Emilia in white linen outside an ornate doorway"><?php else: ?><a class="private-photo-gate" href="gate.php?collection=home&amp;return=<?= rawurlencode($_SERVER['REQUEST_URI']) ?>"><span aria-hidden="true">✦</span><strong>An adventure begins</strong><small>Enter Emilia’s word to look closer</small></a><?php endif; ?>
            <figcaption>She always knows the way.</figcaption>
          </figure>
          <figure class="album-photo personal-photo">
            <?php if ($photoAccess): ?><img src="image.php?id=bb-chair&amp;collection=home" alt="La Davina Emilia seated in a red chair with a glass of wine"><?php else: ?><a class="private-photo-gate" href="gate.php?collection=home&amp;return=<?= rawurlencode($_SERVER['REQUEST_URI']) ?>"><span aria-hidden="true">✦</span><strong>A beautiful evening</strong><small>Enter Emilia’s word to look closer</small></a><?php endif; ?>
